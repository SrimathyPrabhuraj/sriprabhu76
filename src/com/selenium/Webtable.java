...
public class Webtable {
	...
	public static void main(String[] args) {
        ...
        List<WebElement> columnData = driver.findElements(By.xpath("//table/tbody/tr[5]/td"));
        ...
        WebElement particularData = driver.findElement(By.xpath("//table/tbody/tr[2]/td[6]"));
